...
{
    public record AddOfflineWorkingSlot(Guid LawyerId, List<Guid> TimeSlotIds) : ICommand
    {
    ...
    {
        public async Task<ActionResult> HandleAsync(AddOfflineWorkingSlot command, IRepoWrapper repo, CancellationToken cancellationToken = default)
        {
