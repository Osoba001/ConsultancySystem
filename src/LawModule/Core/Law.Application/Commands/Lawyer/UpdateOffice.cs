...
namespace Law.Application.Commands.Lawyer
{
    ...
    {
        public async Task<ActionResult> HandleAsync(UpdateOffice command, IRepoWrapper repo, IServiceProvider ServiceProvider, CancellationToken cancellationToken = default)
        {
